...
public class DeviceProfile {
    ...
    public boolean shouldShowAllAppsOnSheet(@Nullable Context context) {
        if (context != null) {
            ...
            if (AppDrawerStyle.isIos(style) || AppDrawerStyle.isFullscreen(style)) {
                return false;
            }
        }
    ...
    public Rect getHotseatLayoutPadding(Context context) {
        ...
        if (isVerticalBarLayout()) {
            ...
            int availableWidthPx = mDeviceProperties.getAvailableWidthPx();
            int hotseatBarEndOffset = getHotseatProfile().getBarEndOffset();
            int inlineNavButtonsEndSpacingPx = getHotseatProfile().getInlineNavButtonsEndSpacingPx();
