...
public class Workspace<T extends View & PageIndicator> extends PagedView<T>
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSwipeDownGestureMode = Integer.valueOf(
                LauncherPrefs.get(context).devicePrefs.getString("pref_homescreen_swipe_down_gestures", "0"));
        mGestureListener =
    ...
    public void stripEmptyScreens() {
        ...
        for (int i = 0; i < total; i++) {
            ...
            // FIRST_SCREEN_ID can never be removed if quickspace is enabled.
            if ((!Utilities.showQuickspace(getContext())
                    || id > FIRST_SCREEN_ID)
                    && canRemoveEmptyScreen(id, cl)) removeScreens.add(id);
        }
