...
public class PendingAppWidgetHostView extends LauncherAppWidgetHostView
    ...
    public void reapplyItemInfo(ItemInfoWithIcon info) {
        ...
        if (mDisabledForSafeMode) {
            ...
            mSettingIconDrawable = getContext().getResources().getDrawable(R.drawable.ic_setting, getContext().getTheme()).mutate();
            updateSettingColor(info.bitmap.color);

            mDragFlags |= FLAG_DRAW_SETTINGS | FLAG_DRAW_LABEL;
        } else {
            mCenterDrawable = drawableFactory.newPendingIcon(getContext(), info);
            mSettingIconDrawable = null;
            applyState();
        }
