...
object ShapesProvider {
    ...
    private const val IOS_ROUNDED_SQUARE_PATH =
        "M24.00,0.00L76.00,0.00A24.00 24.00 0 0 1 100.00,24.00L100.00,76.00A24.00 24.00 0 0 1 76.00,100.00L24.00,100.00A24.00 24.00 0 0 1 0.00,76.00L0.00,24.00A24.00 24.00 0 0 1 24.00,0.00z"
    ...
    private const val HEXAGON_PATH = "M12,0 88,0 100,50 88,100 12,100 0,50 12,0 Z"
    ...
    private const val ROUNDED_RECT_PATH =
    ...
    private const val SQUIRCLE_PATH =
        "M41.8,0h16.4C72.1,0 77.6,1.5 83,4.4c5.4,2.9 9.7,7.2 12.6,12.6c2.9,5.4 4.4,11 4.4,24.7v16.4c0,13.7 -1.5,19.3 -4.4,24.7c-2.9,5.4 -7.2,9.7 -12.6,12.6c-5.4,2.9 -11,4.4 -24.7,4.4H41.8c-13.8,0 -19.3,-1.5 -24.7,-4.4c-5.4,-2.9 -9.7,-7.1 -12.7,-12.5S0,72 0,58.3V41.9c0,-13.8 1.5,-19.3 4.4,-24.7S11.6,7.4 17,4.5S28.1,0 41.8,0z"
    private const val TAPERED_RECT_PATH =
        "M20,0 80,0 100,20 100,80 80,100 20,100 0,80 0,20 20,0 Z"
    private const val TEARDROP_PATH =
        "M50,0 C77.6,0 100,22.4 100,50 L100,88 C100,94.6 94.6,100 88,100 L50,100 C22.4 100 0 77.6 0 50C0 22.4 22.4 0 50 0 Z"
    private const val VESSEL_PATH =
    ...
    const val IOS_ROUNDED_SQUARE_KEY = "ios_rounded_square"
    ...
    const val RICE_BALLS_KEY = "rice_balls"
    ...
    val iconShapes: Array<IconShapeModel> =
        if (Flags.newCustomizationPickerUi() && LauncherFlags.enableLauncherIconShapes()) {
            arrayOf(
                ...
                IconShapeModel(
                    key = IOS_ROUNDED_SQUARE_KEY,
                    titleId = R.string.ios_rounded_square_shape_title,
                    pathString = IOS_ROUNDED_SQUARE_PATH,
                    folderRadiusRatio = 1 / 3f,
                    shapeRadius = 24f,
                ),
                IconShapeModel(
                ...
                IconShapeModel(
                    key = RICE_BALLS_KEY,
                    titleId = R.string.rice_balls_shape_title,
                    pathString = RICE_BALLS_PATH,
                ),
                IconShapeModel(
