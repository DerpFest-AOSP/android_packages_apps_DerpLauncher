...
public class DrawableFactory implements ResourceBasedOverride {
    ...
    public FastBitmapDrawable newIcon(Context context, ItemInfoWithIcon info) {
        return info.newIcon(context);
    }

    public FastBitmapDrawable newIcon(Context context, BitmapInfo info, ActivityInfo target) {
        return info.newIcon(context, 0, null);
    }

    /**
     * Returns a FastBitmapDrawable with the icon.
     */
    public FastBitmapDrawable newPendingIcon(Context context, ItemInfoWithIcon info) {
        return PreloadIconDelegate.newPendingIcon(info, context);
    }
