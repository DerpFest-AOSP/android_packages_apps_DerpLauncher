...
public class Launcher extends StatefulActivity<LauncherState>
    ...
    protected void setupViews() {
        ...
        mHotseat.setBackgroundResource(
                LauncherPrefs.SHOW_HOTSEAT_BG.get(this) ? R.drawable.bkg_appseat : 0);
    ...
    public Stream<SystemShortcut.Factory> getSupportedShortcuts(ItemInfo itemInfo) {
        ...
        if (container == CONTAINER_DESKTOP || container == CONTAINER_HOTSEAT) {
            return Stream.of(APP_INFO, WIDGETS, INSTALL, UNINSTALL_APP, REMOVE);
            ...
            if (isPinnable) {
                return Stream.of(APP_INFO, WIDGETS, INSTALL, UNINSTALL_APP, ADD_TO_HOME_SCREEN);
            } else {
