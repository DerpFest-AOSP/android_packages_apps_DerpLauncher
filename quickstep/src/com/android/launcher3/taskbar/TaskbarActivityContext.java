...
import static com.android.launcher3.taskbar.TaskbarManagerImpl.NAVBAR_IME_SPACE;
...
public class TaskbarActivityContext extends BaseTaskbarContext {
    ...
    private void applyDeviceProfile(DeviceProfile originDeviceProfile) {
        ...
        mImeDrawsImeNavBar =  getBoolByName(IME_DRAWS_IME_NAV_BAR_RES_NAME, getResources(), false)
                && settingsCache.getIntValue(NAVBAR_IME_SPACE, 1) == 1;
 ...
 *                     for the taskbar create/recreate process.
    ...
    public void init(@NonNull TaskbarSharedState sharedState, int duration) {
        mImeDrawsImeNavBar = getBoolByName(IME_DRAWS_IME_NAV_BAR_RES_NAME, getResources(), false)
                && SettingsCache.INSTANCE.get(this).getIntValue(NAVBAR_IME_SPACE, 1) == 1;
            ...
            if (taskInRecents != null) {
                ...
                if (isProtected) {
                    ...
                    Utilities.showLockScreen(this, getString(R.string.trust_apps_manager_name), () -> {
                        // Re launch instance from recents after authentication
